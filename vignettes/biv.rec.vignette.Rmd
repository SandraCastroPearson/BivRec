...
In this vignette, we introduce how to explore and analyze bivariate recurrent event data using the different methods available in the BivRec package. Most details of function syntax and the produced objects are available in the package manual, which will thus not be covered in this vignette. 
